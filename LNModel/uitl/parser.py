...
def parse_args():
    ...
    # parser.add_argument('--data_path', nargs='?', default='../Data/Cell_Phones_and_Accessories/',
    #                     help='Input data path.')
    parser.add_argument('--data_path', nargs='?', default='../Data/Yelp_Chi/',
                        help='Input data path.')

    parser.add_argument('--proj_path', nargs='?', default='',
                        help='Project path.')
    # parser.add_argument('--dataset', nargs='?', default='2014',
    #                     help='Choose a dataset from {Cell_Phones_and_Accessories 2010-2014, all}')
    parser.add_argument('--dataset', nargs='?', default='',
                        help='Choose a dataset from {NYC 2013-2014}')
    ...
    parser.add_argument('--batch_size', type=int, default=256,
                        help='CF batch size.')
    parser.add_argument('--batch_size_kg', type=int, default=256,
                        help='KG batch size.')
    parser.add_argument('--batch_size_cl', type=int, default=256,
                    help='CL batch size.')

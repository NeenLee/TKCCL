...
import numpy as np
from TSGD.LNModel.LNGNNV2 import myGAT
...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch):
        ...
        *********************************************************
        ...
        for idx in range(n_batch):
            ...
            loss = model("cf", g, sub_cf_g, sub_kg, batch_data['users'],
    ...
    *********************************************************
    ...
    dataframe.to_csv("../output/YelpZip/user_item_anomalyScore_14.csv", index=False, sep=',')
    #
    # print(ret)
